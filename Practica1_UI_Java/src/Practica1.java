...
public class Practica1 extends JFrame implements ActionListener {
    ...
    public Practica1(){
        ...
        IbNombre =new JLabel(); //Creamos objeto
        ...
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //Cerrado automatico
    }

    public void actionPerformed(ActionEvent e){
        if(e.getSource() == btVer){
            JOptionPane.showMessageDialog(this,"Hola: "+ txNombre.getText());
        }
    }
